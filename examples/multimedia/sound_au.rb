...
$soundfile="../common/wipe.au"

# some misuse of one wavfiles ;-)
$sound = SWFSound.new($soundfile, SWFSound::KHZ_11 | SWFSound::BITS_8 | SWFSound::MONO)
$sound2 = SWFSound.new($soundfile, SWFSound::KHZ_22 | SWFSound::BITS_8 | SWFSound::MONO)

# now let's do some funny noisepattern...
$soundinstance = $m.start_sound($sound)
$soundinstance.set_loop_count(20)
$soundinstance.set_loop_out_point(20000)
...
$soundinstance2.set_loop_out_point(100000)
