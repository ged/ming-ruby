...
listener.onMouseMove = function() {
	...
	var ffbv=flash.filters.BevelFilter;
	var filter = new ffbv(yPercent, 45, 0xFFFF00, 0.8, 0x0000FF, 0.8, xPercent, yPercent, 1, 3, 'inner', false);
